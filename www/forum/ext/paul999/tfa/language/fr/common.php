...
$lang = array_merge(
	$lang, array(
		...
		'TFA_SOMETHING_WENT_WRONG'			=> 'Un imprévu est survenu pendant la requête TFA. Veuillez réessayer plus tard',
		'TFA_SOMETHING_WENT_WRONG2'			=> 'Un imprévu est survenu pendant la requête TFA. Arguments invalides',
		'TFA_SOMETHING_WENT_WRONG3'			=> 'Un imprévu est survenu pendant la requête TFA. Retour d\'un code d\'erreur',
		'TFA_SOMETHING_WENT_WRONG4'			=> 'Un imprévu est survenu pendant la requête TFA. Le code random est nul',
		'TFA_SOMETHING_WENT_WRONG5'			=> 'Un imprévu est survenu pendant la requête TFA. Le userId ne correspond pas',
		'TFA_SOMETHING_WENT_WRONG6'			=> 'Un imprévu est survenu pendant la requête TFA. Les codes random ne correspondent pas',
		'TFA_SOMETHING_WENT_WRONG7'			=> 'Un imprévu est survenu pendant la requête TFA. Le code random n\'a pas la bonne longueur, c-à-d 40',
		'TFA_SOMETHING_WENT_WRONG8'			=> 'Un imprévu est survenu pendant la requête TFA. La classe est vide',
		'TFA_SOMETHING_WENT_WRONG9'			=> 'Un imprévu est survenu pendant la requête TFA. Le module est nul',
